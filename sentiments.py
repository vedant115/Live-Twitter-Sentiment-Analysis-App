...
class SentimentAnalysis:
    ...
    def DownloadData(self, keyword, tweets):
        ...
        # authenticating
        consumerKey = 'DGKo4vOJ6g9V0vA58NJzbve0U'
        consumerSecret = 'zKIBc1Uq8Gr0udxeL6gXm5unawzSddmaSWLL231NWDELjqupzJ'
        accessToken = '1524448072541310976-PAVRf7cCKEROvzSPZWCrYAPjfnzr6W'
        accessTokenSecret = 'XNHxiOrbnxpqIUZ6483JxGYZnoVNktuFilz4chyyV5jGy'
    ...
    def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, keyword, tweets):
        ...
        plt.axis('equal')
        plt.tight_layout()
        strFile = r"C:\xampp\htdocs\SentimentAnalysis\static\images\plot1.png"
